...
void loop() {
  ...
  //OscWiFi.send(host_ip, 54321, board, 10*temp.temperature, 10*a.acceleration.y, 10*a.acceleration.z);

  OscWiFi.send(host_ip, 54321, board, abs(g.gyro.x)+abs(g.gyro.y));//, 10*g.gyro.z);
